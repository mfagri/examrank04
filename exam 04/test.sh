...
test_line /bin/ls ftest ";" /bin/ls ";" /bin/ls werwer ";" /bin/ls microshell.c ";" /bin/ls jj.txt ";"
test_line /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";" /bin/ls "|" /usr/bin/grep micro ";"
test_line /bin/cat jj.txt "|" /usr/bin/grep a "|" /usr/bin/grep b ";" /bin/cat jj.txt ";"
test_line /bin/cat jj.txt "|" /usr/bin/grep a "|" /usr/bin/grep w ";" /bin/cat jj.txt ";"
test_line /bin/cat jj.txt "|" /usr/bin/grep a "|" /usr/bin/grep w ";" /bin/cat jj.txt
test_line /bin/cat jj.txt ";" /bin/cat jj.txt "|" /usr/bin/grep a "|" /usr/bin/grep b "|" /usr/bin/grep z ";" /bin/cat jj.txt
test_line ";" /bin/cat jj.txt ";" /bin/cat jj.txt "|" /usr/bin/grep a "|" /usr/bin/grep b "|" /usr/bin/grep z ";" /bin/cat jj.txt
